...
class HomePostCell: UICollectionViewCell {
    ...
    let captionLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: " Some caption text that should wrap onto the next line", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14)]))
    ...
    fileprivate func setupActionsButtons() {
